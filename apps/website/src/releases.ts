...
export const RELEASES: PlatformRelease[] = [
  // ── Windows ─────────────────────────────────────────────────────────────
  {
    ...
    badge: '10 / 11',
    icon: 'windows',
    systemReq: 'Windows 10 64-bit or Windows 11 (x64 & ARM64)',
    recommendedArch: 'exe',
    type: 'download',
    architectures: [
      {
        ...
        sha256: '4635bff04ba64bb3931d91ec176a9af2181f3fcfe78630ce2bcdcc651fd4f4e2',
        available: true,
      },
      {
        arch: 'Windows ARM64 Setup Installer (.exe)',
        format: '.exe',
        fileSize: '97.8 MB',
    ...
    architectures: [
      {
        ...
        sha256: '506c1c576db5ad24c7a5535f99c6e2c3af1523cfcc90871d345e1f0ac5fa42c3',
        available: true,
      },
    ],
  },
